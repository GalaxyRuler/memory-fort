...
const SOURCE_ICON_BG: Record<RawSource, string> = {
  ...
  chatgpt: "bg-entity-tools/15",
  hermes: "bg-entity-tools/15",
  pi: "bg-entity-decisions/15",
  openclaw: "bg-entity-projects/15",
  opencode: "bg-entity-projects/15",
  opencoven: "bg-entity-tools/15",
  vscode: "bg-entity-decisions/15",
...
const SOURCE_ICON_TEXT: Record<RawSource, string> = {
  ...
  chatgpt: "text-entity-tools",
  hermes: "text-entity-tools",
  pi: "text-entity-decisions",
  openclaw: "text-entity-projects",
  opencode: "text-entity-projects",
  opencoven: "text-entity-tools",
  vscode: "text-entity-decisions",
