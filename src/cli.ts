...
program
  ...
  .description("Install hooks + MCP for a platform (claude-code, codex, antigravity, hermes, pi, openclaw, opencoven, opencode, claude-desktop, vscode)")
...
program
  ...
  .description("Uninstall hooks + MCP for a platform (claude-code, codex, antigravity, hermes, pi, openclaw, opencoven, opencode, claude-desktop, vscode)")
  .option("--workspace <path>", "workspace path for clients that support workspace-scoped MCP")
