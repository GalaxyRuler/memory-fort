...
- [ ] **0b.3c (PENDING):** extend probe with **ungraceful** restart-recover (SIGKILL/forced, write-without-checkpoint, re-fork, reopen) + small concurrent-WAL (one writer/one reader). All four installed targets.
