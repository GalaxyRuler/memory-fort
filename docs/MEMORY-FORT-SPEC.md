...
**Memory ops:** `log`, `compile [--execute --plan]`, `curate [--plan|--apply]`, `reindex [--plan]`, `compact-raw [--plan|--apply]`, `consolidate`, `lint`, `page`, `search`, `grep`, `stats`.
